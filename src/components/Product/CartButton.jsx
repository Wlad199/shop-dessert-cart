...
import { addInCart } from '../goodsSlice'
...
const CartButton = ({ name }) => {
	...
	return (
		<div
			...
			onClick={() => dispatch(addInCart(name))}
		>
			<svg className={styles.cartIcon} xmlns="http://www.w3.org/2000/svg" width="21" height="20" fill="none" viewBox="0 0 21 20">
